      ...
      <div className="reports-header">
        <div>
          ...
          <p className="reports-subtitle">
            Weekly engineering summaries generated by AI. A new one is created automatically every
            Monday for repositories with weekly reports enabled in <a href="/settings">Settings</a>.
          </p>
        </div>
      </div>
        ...
        <>
          ...
          {!report && !generating && (
            <div className="reports-placeholder">
              <p>Select a repository and generate a summary of the last 7 days of activity.</p>
            </div>
          )}
